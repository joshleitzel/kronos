(function() {
  var ChronosTime, DateLanguageParser, DateMillisecondsParser, DateNumericParser, DateObjectParser, RelativeTimeString, TimeParser, _isNumeric, _isString;
  ...
  DateLanguageParser = (function() {
    ...
    function DateLanguageParser(languageString, context) {
      ...
      try {
        ...
        return new TimeParser([Date.parse(languageString)]);
      }
    }
